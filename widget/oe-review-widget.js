(function () {
  ...
  function CSS() {
    return [
      ...
      ".awaymark{font-size:12px;opacity:.85;}",
      ...
      "@media (max-width:640px){.wrap.open:not(.standalone){left:0;right:0;bottom:0;transform:none;}.wrap.open:not(.standalone) .panel{width:100vw;max-height:70vh;border-radius:10px 10px 0 0;}}",
